...
namespace RabbitMQ.Client
{
    ...
    public sealed class ConnectionFactory : ConnectionFactoryBase, IConnectionFactory
    {
        ...
        /// </summary>
        /// <remarks>
        /// Completes as <b>cancelled</b>, not as a <see cref="System.TimeoutException"/> as in 6.x.
        /// See <see cref="IConnectionFactory.ContinuationTimeout"/>.
        /// </remarks>
        ...
        private static readonly Dictionary<string, object?> DefaultClientProperties = new Dictionary<string, object?>(5)
        {
            ...
            ["copyright"] = Encoding.UTF8.GetBytes("Copyright (c) 2007-2026 Broadcom."),
